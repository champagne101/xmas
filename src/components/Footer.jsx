  ...
  <footer className="bg-[#d8dede] dark:bg-[#244f6b] w-full py-8 border-t border-[#4681ee]/10 dark:border-white/10">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div>
        ...
        <li><a  className=" text-[#346f8f]/70 dark:text-white/70 hover:text-[#346f8f] dark:hover:text-white transition-colors" href="#">Transfer</a></li>
        <li><a  className=" text-[#346f8f]/70 dark:text-white/70 hover:text-[#346f8f] dark:hover:text-white transition-colors" href="#">Exchange</a></li>
        <li><a  className=" text-[#346f8f]/70 dark:text-white/70 hover:text-[#346f8f] dark:hover:text-white transition-colors" href="#">Onramp</a></li>
        <li><a  className=" text-[#346f8f]/70 dark:text-white/70 hover:text-[#346f8f] dark:hover:text-white transition-colors" href="#">Wallets</a></li>
        </ul>
      </div>
      ...
      <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-[#346f8f]/70 dark:text-white/70 hover:text-[#346f8f] dark:hover:text-white transition-colors">About</a></li>
        ...
        <div>
          ...
          <div className="flex items-center mb-2 text-[#346f8f]/70 dark:text-white/70">
            ...
            <a href="mailto:info@offconnectx.com" className="hover:text-[#346f8f] dark:hover:text-white transition-colors">
